...
function importFromJSON(data, bypass=false) {
    if (bypass || confirm("Are you sure? This will overwrite your current data.")) {
        ...
        if (data.private) {
            if (!bypass && !confirm("You are importing a private save file. This includes sensitive information such as API settings that they entered in. Please make sure you trust the author before importing!")) return;
        } else {
